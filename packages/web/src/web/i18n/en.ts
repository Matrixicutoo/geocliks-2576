...
export const en = {
  ...
  "project.notePlaceholder": "What the crew needs to know on this site",
  "project.noteEdit": "Edit this note",
  "project.noteAdd": "Add a note for the crew",
  "project.on": "on",
  "project.off": "off",
  ...
  "notif.empty": "Nothing new. Messages and new captures from your crew show up here.",
  "notif.sentImage": "sent you an image",
  ...
  "dock.newMessage": "New message",
  "dock.closePicker": "Close",
  "dock.to": "To",
  "dock.search": "Search a teammate",
  "dock.minimize": "Minimize",
  "dock.close": "Close chat",
  "dock.expand": "Open in Messages",
  ...
  "routes.statRuns": "Runs",
  "routes.statRunsSub": "{n} on the road now",
  "routes.statStops": "Stops",
  "routes.statStopsSub": "{n} closed out",
  "routes.statDelivered": "Delivered",
  "routes.statDeliveredSub": "{n} of {total} stops",
  "routes.statDrivers": "Drivers out",
  "routes.statDriversSub": "{n} runs still need one",
  ...
  "routes.stop.pending": "Waiting",
  "routes.stop.delivered": "Delivered",
  ...
  "routes.stop.notePlaceholder": "What the driver needs to know at this address",
  "routes.stop.noteEdit": "Edit this note",
  "routes.stop.noteAdd": "Add a note for the driver",
  ...
  "routes.addHint":
    "One per line. Paste straight from a spreadsheet - tabs, commas or semicolons, with or without a header row. In order: Address, Recipient Name, Email Address, Phone Number.",
  ...
  "routes.sigLabel": "Signature for this address",
  "routes.sigRouteOn": "As route: signature",
  "routes.sigRouteOff": "As route: no signature",
  "routes.sigOn": "Signature required",
  "routes.sigOff": "No signature",
  "routes.sigBadgeOn": "Signature",
  "routes.sigBadgeOff": "No signature",
  "routes.sigCellRoute": "As route",
  ...
  "tc.statOpen": "Still on the clock",
  "tc.statOpenSub": "Shifts with no clock-out",
  ...
  "tc.exportPickOne": "Pick one person to export their timesheet",
  "tc.exportFailed": "Could not build the timesheet. Try again.",
  "tc.noPhoto": "no photo",
  "tc.altitude": "Alt {m} m",
  ...
  "tc.today": "Today",
  "tc.punchesOnly": "Punches only",
  "tc.stillOn": "Still on",
  "tc.punchCount": "{n} punches",
  "tc.emptyDay": "No punches this day",
  "tc.emptyBody": "Clock in from the phone's CLOCK mode or with the buttons above.",
  "tc.in": "In",
  "tc.out": "Out",
  "tc.sourceManual": "Manual punch",
  "tc.sourceCapture": "From capture",
  "tc.amend": "Amend",
  "tc.remove": "Remove punch",
  "tc.shifts": "Shifts",
